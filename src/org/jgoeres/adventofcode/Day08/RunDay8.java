...
public class RunDay8 {
    static String pathToInputs = "day08/input.txt";
    static boolean PRINT_NODETREE_DEBUG = false;

    private static License license = new License(pathToInputs);
     ...
     */
        ...
        Integer sumAllMetadata = license.getRootNode().sumAllMetaData();
        System.out.println("Sum of all metadata:\t " + sumAllMetadata);

        // Answer:
        // Sum of all metadata: 48260
    }
     ...
     */
        ...
        Integer rootNodeValue = license.getRootNode().calculateNodeValue();
        System.out.println("Root node value:\t" + rootNodeValue);

        // Answer:
        // Root node value:	25981
